<meta charset="utf-8"/>
        ...
        <link rel="icon" type="image/gif" href="images/Banker.ico" />
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('css/font_awesome.min.css')}}" />
        ...
        <link href="{{asset('css/registerinformation.css')}}" rel="stylesheet" />
        <!--
            Jquery
        -->
